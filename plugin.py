...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if self.RefreshAndActTime + timedelta(minutes=2):
            ...
            Self.TRVsetpoint = round(self.TRVsetpoint, 1)  # on arrondi au setpoint sans virgule
            Domoticz.Log("TRV rounded Calculded setpoint is : " + str(self.TRVsetpoint))
