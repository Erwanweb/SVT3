        ...
        if Devices[1].sValue == "0":  # Thermostat is off
            ...
            if self.forced:
                if self.endheat <= now:
                    ...
                    self.switchHeat = False
                    self.TRVsetpoint = round(self.setpoint - (self.intemp - self.TRVtemp))  # correction of TRV setpoint using difference between real indoor temp and mesured trv temp.
