...
<plugin key="SVT3" name="AC Smart Virtual Th for TRV" author="logread" version="0.4.4" wikilink="https://www.domoticz.com/wiki/Plugins/Smart_Virtual_Thermostat.html" externallink="https://github.com/999LV/SmartVirtualThermostat.git">
    ...
    <params>
        ...
        <param field="Mode5" label="Calculation cycle, Minimum Heating time per cycle, Pause On delay, Pause Off delay, Forced mode duration (all in minutes), Presence On delay, Presence Off delay" width="200px" required="true" default="30,0,2,1,60,5,30"/>
