...
class BasePlugin:
    ...
    def __init__(self):
        ...
        self.msdelay = 1  # time in minutes for motion sensor reset
        self.ActiveSensors = {}
        self.InTempSensors = []
        self.OutTempSensors = []
        self.Heaters = []
    ...
    def onStart(self):
        ...
        if 1 not in Devices:
            Options = {"LevelActions":"||",
                       ...
                       "SelectorStyle":"0"}
            Domoticz.Device(Name = "Thermostat Control",Unit = 1,TypeName = "Selector Switch",Switchtype = 18,
                            Image = 15,
        ...
        if 7 not in Devices:
            Domoticz.Device(Name = "Heating request",Unit = 7,TypeName = "Switch",Image = 15,Used = 1).Create()
        ...
        self.Motionsensors = parseCSV(Parameters["Mode7"])
        Domoticz.Debug("Motionsensors = {}".format(self.Motionsensors))
        self.TRV = parseCSV(Parameters["Mode8"])
        Domoticz.Debug("TRV = {}".format(self.TRV))
...
def CheckParam(name,value,default):
    try:
        ...
        param = default
        Domoticz.Error(
            "Parameter '{}' has an invalid value of '{}' ! defaut of '{}' is instead used.".format(name,value,default))
    return param
